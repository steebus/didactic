...
insert into exposures (user_id, node_id, source, depth, ability_delta, reason, created_at)
...
from nodes n, generate_series(0, 5) g
...
from nodes n, generate_series(0, 2) g
...
from nodes n, generate_series(0, 7) g
